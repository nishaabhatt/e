  ...
  return (
    <div className='mt-[50px] md:mt-[100px] mb-[100px] md:mb-0'>
        ...
        <Link  href="/" className='transform overflow-hidden bg-white duration-300 hover:scale-105 
            cursor-pointer'>
              <Image src="/watch-2.jpg" className='w-[280px] h-[280px]' alt="" />
        ...
        <Link  href="/" className='transform overflow-hidden bg-white duration-300 hover:scale-105 
            cursor-pointer'>
              <Image src="/perfume.jpeg" className='w-[280px] h-[280px]' alt="" />
               <div className='p-4 text-black/[0.9]'>
                 <h2 className='text-lg font-medium'>Product Name</h2>
                 <div className='flex items-center text-black/[0.5]'>
                   <p className='mr-2 text-lg font-semibold'>$20.00</p>
        ...
        <Link  href="/" className='transform overflow-hidden bg-white duration-300 hover:scale-105 
            cursor-pointer'>
              <Image src="/perfume2.webp" className='w-[280px] h-[280px]' alt="" />
               <div className='p-4 text-black/[0.9]'>
                 <h2 className='text-lg font-medium'>Product Name</h2>
                 <div className='flex items-center text-black/[0.5]'>
                   <p className='mr-2 text-lg font-semibold'>$20.00</p>
        ...
        <Link  href="/" className='transform overflow-hidden bg-white duration-300 hover:scale-105 
            cursor-pointer'>
              <Image src="/handbag2.webp" className='w-[280px] h-[280px]' alt="" />
               <div className='p-4 text-black/[0.9]'>
                 <h2 className='text-lg font-medium'>Product Name</h2>
                 <div className='flex items-center text-black/[0.5]'>
                   <p className='mr-2 text-lg font-semibold'>$20.00</p>
        ...
        <Link  href="/" className='transform overflow-hidden bg-white duration-300 hover:scale-105 
            cursor-pointer'>
              <Image src="/eyeWear2.webp" className='w-[280px] h-[280px]' alt="" />
               <div className='p-4 text-black/[0.9]'>
                 <h2 className='text-lg font-medium'>Product Name</h2>
                 <div className='flex items-center text-black/[0.5]'>
                   <p className='mr-2 text-lg font-semibold'>$20.00</p>
