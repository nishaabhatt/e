       ...
       <Disclosure as="nav" className="md:hidden">
        ...
        peer-focus:left-0 peer:transition ease-out delay-150 duration-200'>
            <div className='flex flex-col justify-start items-center'>
               <Link href="/"><img src='/logo.jpg' className='h-[110px] w-[110px] mt-10 cursor-pointer mx-auto' /></Link> 
            ...
            <div className='my-10 border-b border-gray-100 pb-4'>
                ...
                p-2 rounded-md cursor-pointer hover:shadow-lg'>
                    ...
                    <h3 className='text-base text-gray-800 group-hover:text-white font-semibold'>Men's</h3>
                </div></Link>
                ...
                p-2 rounded-md cursor-pointer hover:shadow-lg'>
                    ...
                    <h3 className='text-base text-gray-800 group-hover:text-white font-semibold'>Women's</h3>
                </div></Link>
