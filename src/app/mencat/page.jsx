  ...
  return (
    <div className='w-full max-w-[90%] px-5 py-10 md:px-10 mx-auto'>
        <h2 className='max-w-xl mx-auto text-center text-3xl lg:text-4xl font-bold py-10'>
            Men's Collections</h2>

        <label >Choose category:</label>
        <select className='my-10 ml-5 p-4  bg-white border focus:outline-none
         shadow text-gray-600 rounded  focus:ring ring-gray-200 group  flex-end' name='category'>
          <option className='  hover:bg-gray-100 border-b  ' value="Top trending" >Top trending</option>
          <option className=' hover:bg-gray-100 border-b  ' value="best seller" >best seller</option>
          <option className=' hover:bg-gray-100 border-b  ' value="all category" selected>all category</option>
        </select>
